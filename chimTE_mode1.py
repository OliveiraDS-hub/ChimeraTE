...
# def bed2pd_begin(intersection_bed):
#     bed2string = str(intersection_bed)
#     bed2string = StringIO(bed2string)
#     pd_df = pd.read_table(bed2string, header=None, sep="\t", usecols=[0,1,2,3,4,5],names=['scaf', 'start', 'end', 'ID', 'dot', 'strand']).drop_duplicates().astype(str)
#     return pd_df
