...
print("\nTranscripts file ==>" + "\t" + str(args.transcripts))
print("TE file ==> " + str(args.te))
if args.assembly:
    print("Transcriptome assembly ==> " + "ON" + "\n")
else:
    print("Transcriptome assembly ==> " + "OFF" + "\n")
...
for index, row in input.iterrows():
    ...
    create_dir(str(out_dir + '/' + group + '/alignment/fpkm_counts'))
    ...
    if check_file(str(out_group + '/chimTEs_raw.tsv')) == True:
        merging_transc()
    if check_file(str(out_group + '/chimTEs_final.tsv')) == True:
        expression()

    ###Assembly
    if args.assembly:
        trinity_out = create_dir(str(out_dir + '/' + group + '/trinity_out'))
