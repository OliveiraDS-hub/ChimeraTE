...
mv *sons.csv tmp_data/scaf_transposons/ ; mv *ltr.csv tmp_data/scaf_ltr/ ; mv *number.csv tmp_data/scaf_copynumber/ ; mv *sorted.csv tmp_data/scaf_TEs/
...
rm -R tmp_data *length *masked *.align *cat.gz *dictio *.log.txt >> /dev/null 2>&1
